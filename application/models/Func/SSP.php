...
class Application_Model_Func_SSP {
    ...
    static function convert_($string) {
        $persian = ['۰', '۱', '۲', '۳', '۴', '۵', '۶', '۷', '۸', '۹'];
        $arabic = ['٠', '١', '٢', '٣', '٤', '٥', '٦', '٧', '٨', '٩'];
    ...
    static function simple($request, $conn, $table, $primaryKey, $columns) {
        ...
        $q = "SELECT " . implode(", ", self::pluck($columns, 'db')) . "
			 FROM $table
			 $where
			 $order 
			 $limit";
    ...
    static function complex($request, $db, $table, $primaryKey, $columns, $whereResult = null, $whereAll = null) {
        ...
        $sqlq = "SELECT " . implode(", ", self::pluck($columns, 'db')) . "
			 FROM $table
			 $where
			 $order
			 $limit";
        // Main query to actually get the data
        $data = self::sql_exec($db, $bindings, $sqlq);
